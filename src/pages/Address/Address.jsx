    ...
    <div className="address-wrapper">
      <div className="address-content">
        ...
        <Formik
          ...
          validationSchema={showAddMannualy ? AddressSchema : null}
          onSubmit={(values) => {
            if (showAddMannualy) {
              nav('/registered'); 
            }
                ...
                {showAddMannualy ? (
                  <div className="add-manualy-div">
                    ...
                    <div className="appartment">
                      ...
                      />
                      <div className="appartment-right">Optional</div>
                    </div>
                    ...
                    <div className="state-zip">
                      ...
                      <div className="zip-code">
                        <div className="zip">
                          ...
                          <Field name="zipCode" type="text" className="zip-code-input" />
                  ...
                  <div className="search-address">
                    ...
                    <div className="location">
                      ...
                      <div className="add-manualy">
                        <p
                          className="current-location-p"
                          onClick={() => setShowAddMannualy(true)}
                        >
                          Add Manually
                        </p>
                      </div>
